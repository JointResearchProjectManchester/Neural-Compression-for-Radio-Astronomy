...
wandb.init(
    ...
    config={
        "architecture": "AE",
        "covariance_method":"RA, delta block diagonal 40x40",
    },
    reinit=True,
)
...
while iteration < num_training_updates:
    ...
    with torch.no_grad():
        ...
        wandb.log({"validation/loss": avg_val_loss.item(),
           "validation/bits_per_dim": bits_per_dim_val.item(),
           "validation/loss_mean": avg_val_loss.item()
           })
